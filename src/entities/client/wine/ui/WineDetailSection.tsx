import { getWineDetailSectionFields, WineData } from '../model';

const WineDetailSection = ({ wineInfoData }: { wineInfoData: WineData }) => {
  return (
    <div className="wine-description-bottom py-12 px-6 bg-white flex flex-col gap-10">
      {getWineDetailSectionFields().map(({ key, value }) => (
        <div
          key={key}
...
export default WineDetailSection;
